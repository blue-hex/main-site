                ...
                <div className="grid grid-cols-3 gap-6">
                    <div className="card block rounded-2xl shadow-2xl border-b px-6 py-6">
                        <div className="flex flex-col w-full items-center space-y-2">
                            ...
                            <h3 className="font-bold">CRM & CXM</h3>
                    ...
                    <div className="card block rounded-2xl shadow-2xl border-b px-6 py-6">
                        <div className="flex flex-col w-full items-center space-y-2">
                            ...
                            <h3 className="font-bold">Enterprise App Development</h3>
                            <p className="text-xs text-left">Our team delivers advanced applications to manage your B2B, B2C and internal business processes. We love to work with web apps, mobile apps, big data apps and iOS/macOS apps development.</p>
                        </div>
                    </div>
                    <div className="card block rounded-2xl shadow-2xl border-b px-6 py-6">
                        <div className="flex flex-col w-full items-center space-y-2">
                            <img src={UI} alt="" className="w-12 h-12 m-0" />
                            <h3 className="font-bold">UI/UX, Web Design & E-Commerce</h3>
                ...
                <div className="grid grid-cols-3 gap-6 mt-6">
                    <div className="card block rounded-2xl shadow-2xl border-b  px-6 py-6">
                        <div className="flex flex-col w-full items-center space-y-3">
                            ...
                            <h3 className="font-bold">Data Analytics & AI, ML and BI</h3>
